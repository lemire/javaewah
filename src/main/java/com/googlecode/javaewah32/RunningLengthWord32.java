...
public final class RunningLengthWord32 implements Cloneable {
     ...
     *          located.
     */
    RunningLengthWord32(final IntArray buffer, final int p) {
        this.buffer = buffer;
        this.position = p;
    }
    ...
    static int getNumberOfLiteralWords(final IntArray buffer, final int position) {
    ...
    static boolean getRunningBit(final IntArray buffer, final int position) {
    ...
    static int getRunningLength(final IntArray buffer, final int position) {
    ...
    static void setNumberOfLiteralWords(final IntArray buffer, final int position, final int number) {
    ...
    static void setRunningBit(final IntArray buffer, final int position, final boolean b) {
        if (b)
    ...
    static void setRunningLength(final IntArray buffer, final int position, final int number) {
