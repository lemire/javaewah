...
/*
 * Copyright 2009-2012, Daniel Lemire, Cliff Moon, David McIntosh, Robert Becho, and Colby Ranger
...
import javaewah.LogicalElement;
  ...
  public int hashCode() {
    ...
    while( i.hasNext() ) {
      ...
      for (int k = 0; k < i.rlw.getNumberOfLiteralWords(); ++k) {
        karprabin += B * karprabin + this.buffer[k + i.dirtyWords()];
      }
    }
    return karprabin;
  }
